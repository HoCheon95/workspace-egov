...
<body>
    ...
    <security:authorize access="isAuthenticated()">
        ...
        <h4>현재 사용자의 인증 정보 : <security:authentication property="principal"/></h4>
        <h4>현재 사용자의 인증 정보 : <security:authentication property="details"/></h4>
        <h4>현재 사용자의 인증 정보 : <security:authentication property="authorities"/></h4>
    </security:authorize>
