...
<html lang="ko">
    ...
    <body>
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <form:form method="post" action="/member/regist" modelAttribute="member" enctype="application/x-www-form-urlencoded">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input id="memPass" type="password" name="memPass" class="form-control" placeholder="비밀번호를 입력하세요" />
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input id="memName" type="text" name="memName" class="form-control" value="${member.memName}" />
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="memAdd1" type="text" name="memAdd1" class="form-control mb-1 mt-2"
                                    value="${member.memAdd1}" placeholder="기본 주소" />
                                    <form:errors path="memAdd1" element="span" class="text-danger"/>
                                    <input id="memAdd2" type="text" name="memAdd2" class="form-control mt-2"
        ...
        <script src="/js/app/member/regisForm.js" type="text/javascript"></script>
    </body>
</html>
