                ...
                <div class="col-md-10">
                    <div class="card shadow">
                        <div class="card-header bg-primary text-white">
                            ...
                            <h4 class="mb-0">
                                <c:choose>
                                    <c:when test="${not empty buyer.buyerId}">📝 거래처 정보 수정</c:when>
                                        <c:otherwise>🏢 신규 거래처 등록</c:otherwise>
                                        </c:choose>
                                    </h4>
                                </div>
                                    ...
                                    <form method="post" action="${pageContext.request.contextPath}${empty buyer.buyerId ? '/buyer/create' : '/buyer/modify'}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="buyerName" name="buyerName" value="${buyer.buyerName}">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="buyerComtel" name="buyerComtel" value="${buyer.buyerComtel}">
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <label for="buyerFax" class="form-label">팩스 번호 (필수)</label>
                                                <input type="text" class="form-control" id="buyerFax" name="buyerFax" value="${buyer.buyerFax}">
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <label for="buyerMail" class="form-label">이메일 (필수)</label>
                                                <input type="email" class="form-control" id="buyerMail" name="buyerMail" value="${buyer.buyerMail}">
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="buyerTelext" name="buyerTelext" value="${buyer.buyerTelext}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex justify-content-end pb-3">
                                            ...
                                            <button type="submit" class="btn btn-primary px-4">
                                                ${empty buyer.buyerId ? '제조사 등록 완료' : '정보 수정 완료'}
                                            </button>
                                        </div>
                                    </form>
                                </div>
