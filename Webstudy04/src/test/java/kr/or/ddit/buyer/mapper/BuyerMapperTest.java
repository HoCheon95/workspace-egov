...
public class BuyerMapperTest {
    ...
    void testInsertBuyer() {
        BuyerDto dummy = mapper.selectBuyer("P10103");
        dummy.setBuyerId(null);
        dummy.setLprodGu(dummy.getLprod().getLprodGu());
        dummy.setBuyerName("테스트 제조사");
        int rowcnt = mapper.insertBuyer(dummy);
